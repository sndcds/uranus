...
func main() {
	...
	*/
	...
	publicRoute.GET("/choosable-languages", api.ChoosableLanguagesHandler)
	...
	adminRoute.DELETE("/event/:eventId/image", app.JWTMiddleware, api_admin.UpdateEventMainImageHandler)
