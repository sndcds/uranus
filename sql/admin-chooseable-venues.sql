...
JOIN {{schema}}.organization_access_grants oag
    ON oag.dst_org_uuid = o.uuid
JOIN {{schema}}.organization src_o
    ON src_o.uuid = oag.src_org_uuid
JOIN {{schema}}.venue v
    ON v.org_uuid = src_o.uuid
